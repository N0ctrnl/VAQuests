...
sub EVENT_ITEM {
  ...
  #tokens
  if(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result<600 ){  
    quest::summonitem(66616,quest::ChooseRandom(1,1,1,2,2,5,10,15,20));

  #stat food
  } elsif(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result>601 && $random_result<1300){  
    quest::summonitem(quest::ChooseRandom(66602,66603,66601));
    # Item(s): Club Sandwich (66602), King's Court Sandwich (66603), Roasted Mammoth Sandwich (66601)

  #gems
  } elsif(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result>1301 && $random_result<1900){  
    quest::summonitem(quest::ChooseRandom(25805,25833,25814,25807,25825,25838,25831));
    # Item(s): Black Marble (25805), Crushed Black Marble (25833), Flawless Diamond (25814), Pristine Emerald (25807), Flawed Sea Sapphire (25825), Crushed Flame Emerald (25838), Crushed Coral (25831)

  #fireworks
  } elsif(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result>1901 && $random_result<2400){  
    quest::summonitem(16880); # Item: Gnomish Firework

  #potions
  } elsif(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result>2401 && $random_result<2800){  
    ...
    # Item(s): Deluxe Sewing Kit (17966), Elixir (66614), Illusionists Stone (14521), Prayers of Life (11631), Vial of Ethereal Mist (66613), Vial of Swirling Smoke (14402), Essence of Troll (96454), Essence of Wood Elf (96456), Essence of Vah Shir (96465), Essence of Ogre (96453), Essence of Iksar (96455), Essence of Human (96459), Essence of High Elf (96458), Essence of Halfling (96462), Essence of Half Elf (96457), Essence of Gnome (96463), Essence of Froglok (96451), Essence of Erudite (96461), Essence of Dwarf (96464), Essence of Dark Elf (96452), Essence of Barbarian (96460)

 #stat items
  } elsif(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result>2801 && $random_result<3000){  
  ...
  #golden ticket
  } elsif(plugin::check_handin(\%itemcount, 66616 => 1) && $random_result==3001){  
