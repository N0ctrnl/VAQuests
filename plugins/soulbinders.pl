...
sub soulbinder_say {
	...
	if($text=~/hail/i){
		...
		quest::say("Greetings ${name} . When a hero of our world is slain their soul returns to the place it was last bound and the body is reincarnated. As a member of the Order of Eternity  it is my duty to [" . quest::saylink("bind your soul") . "] to this location if that is your wish.");
